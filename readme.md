...
- Node device SDK:
   ...
   - [DM Patterns: Reboot (Device Side)](node/device/samples/dmpatterns_reboot_device.js): Shows how a device handles a C2D method to reboot and provides progress updates through twin reported properties. See [DM patterns](dmpatterns.md) for instructions on running the DM patterns samples.
   - [DM Patterns: Firmware Update (Device Side)](node/device/samples/dmpatterns_reboot_device.js): Shows how a device handles a C2D method to initiate a firmware update and provides progress updates through twin reported properties. See [DM patterns](dmpatterns.md) for instructions on running the DM patterns samples.
- Node service SDK:
   ...
   - [DM Patterns: Reboot (Service Side)](node/device/samples/dmpatterns_reboot_service.js): Shows how to initiate a C2D method to reboot a device and view progress through the twin reported properties. See [DM patterns](dmpatterns.md) for instructions on running the DM patterns samples.
   - [DM Patterns: Firmware Update (Service Side)](node/device/samples/dmpatterns_reboot_service.js): Shows how to initiate a C2D method to reboot a device and view progress through the twin reported properties. See [DM patterns](dmpatterns.md) for instructions on running the DM patterns samples.
- Python device SDK:   
